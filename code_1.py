...
def sendEmail(to, content):
    ...
    # Enable  gmail
    server.login('a945ryan@gmail.com', 'harsh9454')
    server.sendmail('a945ryan@gmail.com', to, content)
    server.close()
if __name__ == '__main__':
    ...
    while True:
        ...
        # most asked question from google Assistant
            ...
            client = wolframalpha.Client("ARYAN28G@OUTLOOK.COM")
